...
export default function SignupPage() {
  ...
  const resolver = zodResolver(signupSchema) as Resolver<SignupSchema>;
        ...
        <div className="w-full max-w-md space-y-8 px-4">
          ...
          >
            ...
            <button
              type="submit"
              disabled={loading}
              className="flex w-full justify-center rounded-md bg-black px-4 py-2 text-sm font-medium text-white hover:bg-gray-700 focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 focus:outline-none disabled:opacity-50"
            >
